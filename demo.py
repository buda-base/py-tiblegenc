...
from pytiblegenc import DuffedTextConverter, build_font_hash_index_from_csv, identify_pdf_fonts_from_db, get_glyph_db_path, build_glyph_lookup_tables
...
def converted_txt_from_pdf(pdf_file_name, region=None, page_break_str="\n\n-- page {} --\n\n", remove_non_hz=True, track_font_size=False, font_size_format="<fs:{}>"):
    ...
    with open(pdf_file_name, 'rb') as in_file:
        ...
        device = DuffedTextConverter(rsrcmgr, output_string, stats, region = region, pbs = page_break_str, remove_non_hz=remove_non_hz, font_normalization=font_normalization, error_chr_fun=custom_error_chr, track_font_size=track_font_size, font_size_format=font_size_format, glyph_lookup=glyph_lookup)
...
# [0,50,1000000,500]
#convert_folder("inputjkw/", "outputjkw/", None, "\n\n-- page {} --\n\n")
...
txt = converted_txt_from_pdf("input9/TI1471-01-001.pdf", None, "\n\n-- page {} --\n\n", track_font_size=True)
print(txt)
